...
//conditional donation added in local storage here 
  ...
  <div className="relative mx-4 -mt-6 rounded-lg  text-white ">
    ...
    <div className="bg-[#0B0B0B80]  w-56 lg:w-[45rem] md:w-[27rem] h-14 lg:h-14 lg:mt-18 mt-16 md:mt-48 lg:mt-[23rem] md:mr-2 md:mb-2  absolute lg:ml-4 ml-4 md:ml-4" lg:style={{backgroundColor:"#0B0B0B80" ,marginTop:"340px "  ,width:"300px", height:"100px", position:"absolute",marginLeft:"16px"} }>
    <button onClick={handleDonateAdd}     style={{backgroundColor:text_color}}
      className="select-none absolute flex justify-center items-center mt-4 lg:-mb-6 ml-4  w-20 lg:w-36 text-[#fff] font-semibold text-xl rounded-lg py-2 lg:py-3 px-4 lg:px-6 text-center items-center font-sans text-xs font-normal lg:font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
      type="button"
